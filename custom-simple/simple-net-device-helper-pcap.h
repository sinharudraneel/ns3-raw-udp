...
/**
 * @brief build a set of SimpleNetDevicePcap objects
 */
class SimpleNetDeviceHelperPcap : public PcapHelperForDevice
{
  public:
    /**
     * Construct a SimpleNetDeviceHelperPcap.
     */
     ...
     * SimpleNetDevicePcap created through SimpleNetDeviceHelperPcap::Install.
     */
     ...
     * SimpleNetDevice created through SimpleNetDeviceHelperPcap::Install.
     */
    template <typename... Ts>
     ...
     * by SimpleNetDeviceHelperPcap::Install
     */
    ...
    /**
     * This method creates an ns3::SimpleChannelPcap with the attributes configured by
     * SimpleNetDeviceHelperPcap::SetChannelAttribute, an ns3::SimpleNetDevice with the attributes
     * configured by SimpleNetDeviceHelperPcap::SetDeviceAttribute and then adds the device
     ...
     * SimpleNetDeviceHelperPcap::SetDeviceAttribute and then adds the device to the node and
    ...
    /**
     * This method creates an ns3::SimpleChannelPcap with the attributes configured by
     * SimpleNetDeviceHelperPcap::SetChannelAttribute.  For each Ptr<node> in the provided
     * container: it creates an ns3::SimpleNetDevice (with the attributes
     * configured by SimpleNetDeviceHelperPcap::SetDeviceAttribute); adds the device to the
     ...
     * SimpleNetDeviceHelperPcap::SetDeviceAttribute); adds the device to the node; and attaches
...
template <typename... Ts>
void
SimpleNetDeviceHelperPcap::SetQueue(std::string type, Ts&&... args)
{
...
template <typename... Ts>
void
SimpleNetDeviceHelperPcap::SetChannel(std::string type, Ts&&... args)
{
...
#endif /* SIMPLE_NETDEVICE_HELPER_PCAP_H */
